...
|---|---|---|---|---|---|---|
| S1 | arXiv:2410.24148 + DOI:10.1038/s41598-026-39584-3 | **Nouar AlDahoul, Myles Joshua Toledo Tan, Harishwar Reddy Kasireddy, Yasir Zaki** | Exploring Vision Language Models for Facial Attribute Recognition: Emotion, Race, Gender, and Age (arXiv) / FaceScanPaliGemma Multi-Agent Vision Language Models for Facial Attribute Recognition (Nature) | **Nature Scientific Reports 2026** (aceito 5 fev 2026; DOI 10.1038/s41598-026-39584-3) — arXiv preprint v1 31 Oct 2024 | ✅ VERIFIED | "Hassanpour et al. 2024" — INCORRETO; venue atualizado de arXiv preprint para Nature SR (Rodada 2.5 SOTA verification 2026-05-25) |
