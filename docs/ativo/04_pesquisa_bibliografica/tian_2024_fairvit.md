...
fonte_leitura: PDF baixado de arXiv/OpenAccess (pdfs/tian_2024_fairvit.pdf). Validacao Nivel 2 (Camada 2) em 2026-06-15 - abstract e tabelas-chave lidos via pdftotext; ficha alinhada com pente fino do corpus.
---
