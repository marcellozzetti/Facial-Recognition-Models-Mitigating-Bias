# Inventário de PDFs do corpus
Gerado em: 2026-06-15

- Total de fichas: **101**
- Fichas com PDF identificado: **92**
- Fichas sem PDF: **9**
- PDFs presentes em `pdfs/`: **90**
...
| Ficha | Status | DOI / URL |
|---|---|---|
| `debiasing_neural_interventions_2025` | OVERVIEW_ONLY | https://link.springer.com/chapter/10.1007/978-3-032-21324-2_32 |
| `dp_fedface_2024` | OVERVIEW_ONLY | 10.1145/3627673.3679901 |
| `fairimagen_neurips2025` | OVERVIEW_ONLY | https://blog.neurips.cc/category/2025-conference/ |
| `federated_fairness_survey_2025` | OVERVIEW_ONLY | 10.1002/aisy.202400836 |
| `fitzpatrick_1988` | VERIFIED | 10.1001/archderm.1988.01670060015008 |
| `fuentes_2019` | VERIFIED | 10.1002/ajpa.23882 |
| `lewontin_1972` | VERIFIED | 10.1007/978-1-4684-9063-3_14 |
| `massey_martin_2003` | VERIFIED | https://scales.arabpsychology.com/s/new-immigrant-survey-skin-color-scale/ |
| `racial_bias_dataset_2017` | OVERVIEW_ONLY | 10.1145/3600211.3604662 |

## Inventário completo

| Ficha | Status | PDF presente | arXiv |
|---|---|---|---|
| `aguirre_2023` | VERIFIED | aguirre_2023 | 2305.12671 |
| `aldahoul_2024` | VERIFIED | aldahoul_2024_vlm | 2410.24148 |
| `benchmark_lvlm_2026` | OVERVIEW_ONLY | benchmark_lvlm_2026 | 2602.03895 |
| `bendvlm_2024` | OVERVIEW_ONLY | bendvlm_2024 | 2411.04420 |
| `bhaskaruni_2019` | VERIFIED | bhaskaruni_2019_ensemble | — |
| `bian_2025_lorafair` | OVERVIEW_ONLY | bian_2025_lorafair | a confirmar |
| `bias_subspace_2025` | OVERVIEW_ONLY | bias_subspace_2025 | 2511.18123 |
| `biopro_2025` | OVERVIEW_ONLY | biopro_2025 | 2512.00807 |
| `buolamwini_2018` | VERIFIED | buolamwini_2018_gendershades | — |
| `closed_form_debias_2026` | OVERVIEW_ONLY | closed_form_debias_2026 | 2603.12998 |
| `counterfactual_fairness_iclr2025` | OVERVIEW_ONLY | counterfactual_fairness_iclr2025 | — |
| `dataset_bupt_2019` | OVERVIEW_ONLY | dataset_karkkainen_2021 | — |
| `dataset_hazirbas_2021` | VERIFIED | dataset_hazirbas_2021 | 2104.02821 |
| `dataset_karkkainen_2021` | VERIFIED | dataset_karkkainen_2021 | 1908.04913 |
| `dataset_robinson_2020` | VERIFIED | dataset_robinson_2020 | 2002.06483 |
| `dataset_wang_2019` | VERIFIED | dataset_wang_2019 | 1812.00194 |
| `debiasing_neural_interventions_2025` | OVERVIEW_ONLY | — | — |
...
| `fair_residuals_vlm_2025` | OVERVIEW_ONLY | fair_residuals_vlm_2025 | 2505.23798 |
...
| `federated_fairness_survey_2025` | OVERVIEW_ONLY | — | — |
| `fitzpatrick_1988` | VERIFIED | — | — |
| `frcsyn_2024` | OVERVIEW_ONLY | frcsyn_2024 | 2404.10378 |
| `fuentes_2019` | VERIFIED | — | — |
| `gras_2025` | OVERVIEW_ONLY | gras_2025 | 2508.18989 |
| `grother_2019` | VERIFIED | grother_2019_nistir8280 | — |
| `hardt_2016` | VERIFIED | hardt_2016_eqopp | 1610.02413 |
...
| `unified_debiasing_vlm_2024` | OVERVIEW_ONLY | unified_debiasing_vlm_2024 | 2410.07593 |
| `variface_2024` | OVERVIEW_ONLY | variface_2024 | 2412.06235 |
| `voidface_2025` | OVERVIEW_ONLY | voidface_2025 | 2508.07960 |
| `wang_2018_cosface` | OVERVIEW_ONLY | wang_2019_rfw | 1801.09414 |
| `zemel_2013` | VERIFIED | zemel_2013_lfr | — |
| `zhang_2018` | VERIFIED | zhang_2018_adversarial | 1801.07593 |
| `zhao_2025_aimfair` | OVERVIEW_ONLY | zhao_2025_aimfair | a confirmar |
