"""Gera apresentacao PowerPoint da reuniao 2026-07-20.

Atualizacao unica desta semana: escrita da qualificacao fechada.

- Marco 30/jul (pedido formal) em 10 dias
- 5 capitulos completos no Overleaf (template abnTeX2 oficial Unifesp)
- Padrao ABNT NBR 10520 aplicado
- 42 chaves BibTeX validadas
- Glossario com 73 termos

Uso:
    python _gerar_apresentacao_2026-07-20.py
    -> produz: docs/ativo/material_reuniao_orientador_2026-07-20.pptx
"""
...
def add_title_slide(prs: Presentation) -> None:
    ...
    p2 = tf.add_paragraph()
    p2.text = "Escrita da qualificação fechada — pronta para o pedido formal em 30/jul"
    p2.font.size = Pt(20)
...
def build_presentation() -> Presentation:
    ...
    add_bullets(
        ...
        [
            ("", ""),
            ("Atualização única:", "escrita da qualificação está FECHADA — 5 capítulos completos, migrados para o template abnTeX2 oficial da Unifesp, padrão ABNT NBR 10520 aplicado, 42 chaves BibTeX validadas"),
            ("", ""),
            ("Alinhamento:", "pedido formal de qualificação em 30/jul (10 dias)"),
        ],
        footer="Já resolvido: Declaração de Responsabilidade CEP submetida em 12/jul (Art. 8º Res. 200/2021).",
    )
    ...
    add_table_slide(
        ...
        [
            ["1", "Primeira revisão da qualificação ao orientador", "15/jul/2026", "CONCLUÍDO — Overleaf compartilhado desde 13/jul"],
            ["2", "Pedido formal de qualificação ao PPG-CC / ICT", "30/jul/2026", "EM CURSO — 10 dias; escrita fechada, aguardando ajustes desta reunião"],
            ["3", "Defesa da qualificação", "outubro/2026", "Sujeita à prorrogação de 2 meses solicitada (afastamento parental)"],
        ],
        col_widths=[0.5, 5.5, 2.0, 5.0],
        highlight_rows=[1],
        footer="Marco 1 entregue. Marco 2 é o foco imediato: escrita já está pronta para submissão.",
    )
    ...
    add_bullets(
        prs,
        "Escrita fechada — 5 capítulos completos no Overleaf",
        [
            ("Cap 1 — Introdução:", "aprox. 1200 palavras; contexto NIST/FRVT, problema Latinx 60 %, diagnóstico intra-categorial"),
            ("Cap 2 — Revisão:", "aprox. 1985 palavras; seis frentes, tripé Latinx, alternativas de conditioning ponderadas, cinco lacunas"),
            ("Cap 3 — Objetivos:", "aprox. 896 palavras; OG + 6 OEs + 6 hipóteses + 7 contribuições"),
            ("Cap 4 — Metodologia:", "aprox. 1200 palavras; pipeline 6 etapas + 4 configurações + ética CEP"),
            ("Cap 5 — Cronograma:", "aprox. 692 palavras; marcos + riscos + próximos passos"),
            ("", ""),
            ("Complementos:", "resumo 500 palavras sem citações (NBR 6028) + glossário com 73 termos (pós-textual)"),
            ("Total do corpo textual:", "aprox. 5970 palavras + resumo + glossário + referências"),
        ],
        footer="Escrita finalizada em 19/jul; documento pronto para submissão em 30/jul após ajustes desta reunião.",
    )

    add_bullets(
        prs,
        "Padronização institucional — template abnTeX2 oficial da Unifesp",
        [
            ("Template adotado:", "abnTeX2 / ICMC adaptado à Unifesp (classe icmc.cls, estilo bibliográfico abntexalfenglish.bst)"),
            ("", ""),
            ("Citações — padrão ABNT NBR 10520 (autor-data):"),
            ...
            ("", ""),
            ("Estrutura ABNT NBR 14724:", "elementos pré-textuais / textuais / pós-textuais organizados em tex/pre-textual, tex/textual, tex/glossario"),
            ("Bibliografia:", "104 entradas em references.bib; 42 chaves usadas nos capítulos; 100 % validadas contra o .bib"),
        ],
        footer="Todos os elementos institucionais (capa, folha de rosto, ficha catalográfica, dedicatória, agradecimentos, epígrafe) prontos no template.",
    )
    ...
    add_bullets(
        prs,
        "Perguntas em aberto — foco no pedido formal de 30/jul",
        [
            ("1. Overleaf:",
             "o senhor teve chance de percorrer algum capítulo? Algum ponto crítico para ajustar antes de 30/jul?"),
            ("2. Ficha catalográfica:",
             "pela Biblioteca da Unifesp, qual o prazo típico? Precisa entrar no pedido formal ou só na versão pós-defesa?"),
            ("3. Extensão de 2 meses:",
             "trâmite correto — carta direta ao senhor, requerimento SEI ao PPG, ou processo formal com anexos?"),
            ("4. Co-orientador:",
             "alguma definição para constar na versão formal do pedido?"),
            ("5. Banca preliminar:",
             "sugestões de nomes para começarmos a articular contatos?"),
            ("Bônus técnica:",
             "as 4 configurações (A/B/C/D) bastam ou incluo uma 5ª variante com skin tone contínuo (ITA/L*) em vez de MST discreto?"),
        ],
        footer="Nesta semana aplico os ajustes desta reunião e faço o pedido formal em 30/jul.",
    )
...
def main() -> None:
    ...
    out = here / "material_reuniao_orientador_2026-07-20.pptx"
