...
\begin{enumerate}
\item ResNet-34, \emph{baseline} canônico originalmente treinado por \textcite{karkkainen2021fairface} sobre o FairFace~\autocite{aldahoul2024exploring};
